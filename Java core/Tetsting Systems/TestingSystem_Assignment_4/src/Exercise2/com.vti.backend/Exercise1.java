package Exercise2.com.vti.backend;
...
public class Exercise1 {
    ...
    //họ
    public static void Question8(Account[] accArr) {
    ...
    public static void Question9(Department[] DerArr) {
    ...
    public static void Question11(Department[] DepArr) {
    ...
    public static void Question16(Account[] AccArr, Department[] DepArr) {
        // Question 10
    ...
    public static void Question17(Account[] AccArr, Department[] DepArr) {
        // Question 10
        System.out.println("Question 10: ");
        int a = 0;
        do {

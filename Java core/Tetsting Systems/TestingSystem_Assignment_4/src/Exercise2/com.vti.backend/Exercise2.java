...
public class Exercise2 {
    ...
    public static void Question2(int b) {
    ...
    public static void Question3(float c) {
    ...
    public  static  void  Question4(String s){
        System.out.printf("Tên tôi là \"" + s + "\" và tôi đang độc thân\n");
    }
    //Question 5:
    //Lấy thời gian bây giờ và in ra theo định dạng sau:
    //24/04/2020 11h:16p:20s
    public  static  void  Question5(Date datenow){
    ...
    public  static  void Question6(Account [] accArr ){

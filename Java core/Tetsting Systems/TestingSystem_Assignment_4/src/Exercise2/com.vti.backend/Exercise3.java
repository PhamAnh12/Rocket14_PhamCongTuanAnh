...
import Exercise2.com.vti.entity.Exam;
...
public class Exercise3 {
    ...
    public  static  void Question1(Exam ex1){
...
//Năm – tháng – ngày – giờ – phút – giây
    public  static  void Question2(Exam [] ExArr){
    ...
    public  static  void Question3(Exam [] ExArr) {
...
//Question 4: Chỉ in ra tháng và năm của create date property trong Question 2
    ...
    public  static  void Question4(Exam [] ExArr){
    ...
    public  static  void Question5(Exam [] ExArr){

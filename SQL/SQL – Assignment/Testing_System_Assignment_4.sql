...
SELECT a.AccountID, a.Email, a.Username, a.FullName, IF(d.DepartmentName IS NULL, 'Nhan vien nay chua thuoc phong ban nao', d.DepartmentName) AS DepartmentName 
FROM `account` a
